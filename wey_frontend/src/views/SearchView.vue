        ...
        <div class="main-left col-span-3 space-y-4">
            ...
            <div class="bg-white  border border-gray-200 rounded-lg">
                <div class="p-4 flex space-x-4">
                    <input type="search" class="p-4 w-full bg-gray-100 rounded-lg" placeholder="Введите запрос">
                    <a href="#" class="inline-block py-4 px-6 bg-purple-500 text-white rounded-lg">Post</a>
                </div>
            </div>
